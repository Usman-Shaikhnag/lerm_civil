...
class MechanicalMorterCube(models.Model):
    ...
    morter_cube_child_lines = fields.One2many('mechanical.morter.cube.line','parent_id',string="Parameter")
    ...
    def _compute_confirmity(self):
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','c87e9124-8d45-416c-b5e0-c9533235f188')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','c87e9124-8d45-416c-b5e0-c9533235f188')]).parameter_table
    ...
    def _compute_visible(self):
        ...
        for record in self:
            ...
            for sample in record.sample_parameters:
                ...
                if sample.internal_id == "c87e9124-8d45-416c-b5e0-c9533235f188":
    ...
    def get_all_fields(self):
        record = self.env['mechanical.morter.cube'].browse(self.ids[0])
        field_values = {}
...
class MechanicalMorterCubeLine(models.Model):
    _name = "mechanical.morter.cube.line"
    parent_id = fields.Many2one('mechanical.morter.cube',string="Parent Id")
