...
class MortarCubeDatasheet(models.AbstractModel):
        _name = 'report.lerm_civil.mortar_cube_datasheet'
        _description = 'Tile  Mortar Cube DataSheet'
...
class MortarCubeReport(models.AbstractModel):
    _name = 'report.lerm_civil.mortar_cube_report'
    _description = 'Mortar Cube Report'
