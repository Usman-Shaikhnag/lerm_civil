...
class TileChequredCementDatasheet(models.AbstractModel):
        _name = 'report.lerm_civil.cement_tile_chequred_datasheet'
...
class TileCementChequeredReport(models.AbstractModel):
    _name = 'report.lerm_civil.cement_tile_chequered_report'
