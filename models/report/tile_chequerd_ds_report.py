...
class TileChequredDatasheet(models.AbstractModel):
        _name = 'report.lerm_civil.tile_chequred_datasheet'
...
class TileChequeredReport(models.AbstractModel):
    _name = 'report.lerm_civil.tile_chequered_report'
